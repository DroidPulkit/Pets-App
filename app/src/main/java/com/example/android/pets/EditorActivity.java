...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void savePet(){
        ...
        values.put(PetContract.PetEntry.COLUMN_PET_GENDER,genderInteger);
        ...
        if(currentPetUri == null) {
            ...
            Integer oldUri = getContentResolver().update(currentPetUri,values,null,null);

            if(oldUri == 0){
                Toast.makeText(this, "Error while updating Database",
                        Toast.LENGTH_SHORT).show();
            } else {
    ...
    private void deletePet() {
        if (currentPetUri != null) {
            int noRowsDeleted = getContentResolver().delete(currentPetUri, null, null);
            if (noRowsDeleted >= 1) {
